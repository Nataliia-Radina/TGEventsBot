...
class TestDailyReminderService extends DailyReminderService {
  // Override the filterTodaysEvents method to test different dates
  public testFilterEventsForDate(events: any[], testDate: Date): any[] {
  ...
  async testDifferentScenarios(): Promise<void> {
